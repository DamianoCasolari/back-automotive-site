...
@section('content')
    <section>
        ...
        <div class="container d-flex justify-content-center align-items-center flex-column vh_100_without_header position-relative">
            ...
            <div class="border border-1 rounded-5 mt-3 mt-md-0">
                <a class="btn bg_special text-end strong_shadow " href="{{ route('admin.ads.create') }}">
                    <span class="icon">
                ...
                @forelse($ads as $ad)
                    <div class="col-12 d-flex align-items-center justify-content-between border_car_card flex-wrap rounded-1 my-4">
                        <div class="col-12 col-sm-6 col-md-6 my-3 position-relative">
                            <img src="{{ asset('storage/' . $ad->cover_image) }}" alt="Immagine {{ $ad->name }}"
                        ...
                        <div
                            ...
                            <div>
                                <div class="text_cloudy mb-3 fs-5"><strong class="text_fire">Prezzo vettura</strong> {{ $ad->price}}€</div>
                                <div class="text_cloudy mb-3 fs-5" ><strong class="text_fire">Km</strong> {{ $ad->km}}€</div>
                            ...
                            <div class="index_buttons">
                                <div
                                    ...
                                    <button type="button" class="btn bg_pomegranate my-2 strong_shadow " data-bs-toggle="modal"
                                        ...
                                        <span class="text_from_left text_cloudy ">Elimina</span>
                                    </button>
