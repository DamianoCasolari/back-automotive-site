            ...
            <div class="col">
                <div class=" p-3 my-5 ">
                    ...
                    <div>
                        ...
                        <form id="create_ad_form" class="text_fire" action="{{ route('admin.ads.update',$ad) }}" method="post"
...
{{-- IMMAGINI --}}
                            ...
                            <div class="d-flex justify-content-between flex-wrap align-items-center">
                                <div class="mb-3 col-12 col-md-8">
                                    ...
                                    <input type="file" class="form-control shadow" name="cover_image" id="cover_image"
                                        aria-describedby="helpId" accept="image/*" value="{{ old('cover_image', $ad->cover_image) }}" >
                                    @error('cover_image')
                                ...
                                <div id="cover_image-preview-container"
                                    ...
                                    <img id="cover_image-preview" src="{{ $ad->cover_image ? asset('storage/uploads/' . $ad->cover_image) : '#'  }}" alt="Preview dell'immagine"
                            ...
                            <div class="d-flex justify-content-between flex-wrap align-items-center">
                                ...
                                <div id="cover_image2-preview-container" class="mt-2 col-12 col-md-4 d-flex justify-content-center strong_shadow {{$ad->cover_image2 ? '' : 'd-none'}}">
                                    <img id="cover_image2-preview" src="{{ $ad->cover_image2 ? asset('storage/uploads/' . $ad->cover_image2) : '#'  }}" alt="Preview dell'immagine"
                                        style="max-width: 100%;" class="p-3">
                                </div>
                            </div>
                            <div class="d-flex justify-content-between flex-wrap align-items-center">
                                ...
                                <div id="cover_image3-preview-container" class="mt-2 col-12 col-md-4 d-flex justify-content-center strong_shadow {{$ad->cover_image3 ? '' : 'd-none'}}">
                                    <img id="cover_image3-preview" src="{{ $ad->cover_image3 ? asset('storage/uploads/' . $ad->cover_image3) : '#'  }}" alt="Preview dell'immagine"
                                        style="max-width: 100%;" class="p-3">
                                </div>
                            </div>
                            <div class="d-flex justify-content-between flex-wrap align-items-center">
                                ...
                                <div id="cover_image4-preview-container" class="mt-2 col-12 col-md-4 d-flex justify-content-center strong_shadow {{$ad->cover_image4 ? '' : 'd-none'}}">
                                    <img id="cover_image4-preview" src="{{ $ad->cover_image4 ? asset('storage/uploads/' . $ad->cover_image4) : '#'  }}" alt="Preview dell'immagine"
                                        style="max-width: 100%;" class="p-3">
                                </div>
                            </div>
                            <div  class="d-flex justify-content-between flex-wrap align-items-center">
                                ...
                                <div id="cover_image5-preview-container" class="mt-2 col-12 col-md-4 d-flex justify-content-center strong_shadow {{$ad->cover_image5 ? '' : 'd-none'}}">
                                    <img id="cover_image5-preview" src="{{ $ad->cover_image5 ? asset('storage/uploads/' . $ad->cover_image5) : '#'  }}" alt="Preview dell'immagine"
                                        style="max-width: 100%;" class="p-3">
                                </div>
                            </div>
{{-- OTHER INFO--}}
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control shadow" name="name" id="name"
                                    aria-describedby="helpId" placeholder="" value="{{ old('name', $ad->name) }}" required>
                                @error('name')
                                ...
                                <select class="form-select shadow @error('brand') is-invalid @enderror"
                                    ...
                                    @foreach ($brands as $brand)
                                        <option value="{{ $brand->id }}"
                                            {{ $brand->id == old('brand', $ad->brand) ? 'selected' : '' }}>
                                            {{ $brand->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control shadow" name="model" id="model"
                                    aria-describedby="helpId" placeholder="" value="{{ old('model', $ad->model ) }}" >
                                @error('model')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control shadow" name="km" id="km"
                                    aria-describedby="helpId" placeholder="" value="{{ old('km', $ad->km) }}" required>
                                @error('km')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control shadow" name="date_of_enrollment" id="date_of_enrollment"
                                    aria-describedby="helpId" placeholder="" value="{{ old('date_of_enrollment', $ad->date_of_enrollment ) }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control shadow" name="fuel_type"
                                    ...
                                    value="{{ old('fuel_type', $ad->fuel_type) }}" >
                                @error('fuel_type')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control shadow" name="transmission" id="transmission"
                                        aria-describedby="helpId" placeholder="" value="{{ old('transmission', $ad->transmission) }}" >
                                @error('transmission')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control shadow" name="engine_displacement"
                                    ...
                                    value="{{ old('engine_displacement', $ad->engine_displacement) }}" >
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control shadow" name="car_doors_number"
                                    ...
                                    value="{{ old('car_doors_number', $ad->car_doors_number) }}" >
                                @error('car_doors_number', $ad->car_doors_number)
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control shadow" name="description" id="description"  rows="3">{{ old('description', $ad->description) }}</textarea>
                                @error('description')
                                    <small class="text-danger">Per favore, inserisci correttamente la descrizione.</small>
                                @enderror
                            </div>

                            <button type="submit" class="btn btn-dark w-100 text-uppercase strong_shadow ">Modifica
                                annuncio</button>
                        </form>
                    </div>
                </div>
